                ...
                case 3:
                    switch (fmt.cf) {
                        ...
                        case SINT8:
                            return (GL3.GL_RGB8I);
                        case UINT8:
                            return (GL3.GL_RGB8UI);
                        case SINT16:
                            return (GL3.GL_RGB16I);
                        case UINT16:
                            return (GL3.GL_RGB16UI);
                        case SINT32:
    ...
    static int texefmt1(VectorFormat ifmt, VectorFormat efmt, Swizzle perm) {
        ...
        if ((perm == null) || perm.idp()) {
            if (!glattribint(efmt.cf)) {
                ...
                switch (efmt.nc) {
                    case 1:
                        return (GL3.GL_RED_INTEGER);
                    case 2:
                        return (GL3.GL_RG_INTEGER);
                    case 3:
                        return (GL3.GL_RGB_INTEGER);
                    case 4:
                        return (GL3.GL_RGBA_INTEGER);
                }
            }
        } else {
