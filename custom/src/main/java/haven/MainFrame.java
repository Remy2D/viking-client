...
public class MainFrame extends java.awt.Frame implements Runnable, Console.Directory {
    ...
    private static final String TITLE = "Viking Client";
    ...
    private void seticon() {
        Image icon;
        try {
            InputStream data = MainFrame.class.getResourceAsStream("/haven/icon.png");
    ...
    public static void setupres() {
        ...
        if (!Config.nopreload) {
            try {
                InputStream pls;
                pls = Resource.class.getResourceAsStream("/haven/res-preload");
                if (pls != null)
                    Resource.loadlist(Resource.remote(), pls, -5);
                pls = Resource.class.getResourceAsStream("/haven/res-bgload");
                if (pls != null)
